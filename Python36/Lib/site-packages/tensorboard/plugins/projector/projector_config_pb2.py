...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorboard/plugins/projector/projector_config.proto',
...
_SPRITEMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='image_path', full_name='tensorboard.projector.SpriteMetadata.image_path', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='single_image_dim', full_name='tensorboard.projector.SpriteMetadata.single_image_dim', index=1,
...
_EMBEDDINGINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor_name', full_name='tensorboard.projector.EmbeddingInfo.tensor_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata_path', full_name='tensorboard.projector.EmbeddingInfo.metadata_path', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bookmarks_path', full_name='tensorboard.projector.EmbeddingInfo.bookmarks_path', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='tensorboard.projector.EmbeddingInfo.tensor_shape', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sprite', full_name='tensorboard.projector.EmbeddingInfo.sprite', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor_path', full_name='tensorboard.projector.EmbeddingInfo.tensor_path', index=5,
...
_PROJECTORCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='model_checkpoint_path', full_name='tensorboard.projector.ProjectorConfig.model_checkpoint_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='embeddings', full_name='tensorboard.projector.ProjectorConfig.embeddings', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='model_checkpoint_dir', full_name='tensorboard.projector.ProjectorConfig.model_checkpoint_dir', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
