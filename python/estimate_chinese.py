...
if __name__ =='__main__':
    ...
    with tf.Session() as sess:
        ...
        y = "中文字符识别结果为：%s"%PROVINCES[nProvinceIndex]

        text = y
        im = Image.new("RGB", (300, 300), (255, 255, 255))
        font = pygame.font.Font(os.path.join("python/fonts/", "msyh.ttc"), 34)
        rtext = font.render(text, True, (0, 0, 0), (255, 255, 255))
        pygame.image.save(rtext, "python/result/1.jpg")
        line = Image.open("python/result/1.jpg")
        im.paste(line, (10, 5))
        src2 = cv2.imread("python/result/1.jpg")
        #cv2.imshow("result2", src2)
        src2 = cv2.resize(src2, (300, 45))
        cv2.imshow("result", src2)
        cv2.waitKey(0)
        text = PROVINCES[nProvinceIndex]
        im = Image.new("RGB", (300, 300), (255, 255, 255))
        font = pygame.font.Font(os.path.join("python/fonts/", "msyh.ttc"), 34)
        rtext = font.render(text, True, (0, 0, 0), (255, 255, 255))
